...
/* ANSI 终端控制（清屏/回车/颜色等） */
#ifndef SCL_EX_SHELL_ANSI_EN
#define SCL_EX_SHELL_ANSI_EN     1u
#endif

/* 行编辑能力（退格、Ctrl-U、字符插入/覆盖） */
#ifndef SCL_EX_SHELL_EDIT_EN
#define SCL_EX_SHELL_EDIT_EN     1u
#endif

/* 历史浏览（↑/↓，回放命令） */
#ifndef SCL_EX_SHELL_HISTORY_EN
#define SCL_EX_SHELL_HISTORY_EN  1u
#endif

/* 命令/变量补全与 usage 提示 */
#ifndef SCL_EX_SHELL_COMPLETION_EN
#define SCL_EX_SHELL_COMPLETION_EN 1u
#endif

/* ESC / CSI 方向键处理（如 ↑/↓/←/→） */
#ifndef SCL_EX_SHELL_CURSOR_EN
#define SCL_EX_SHELL_CURSOR_EN   1u
#endif

/* 左右光标移动 + 行内编辑（←/→/Home/End/删除前单词） */
#ifndef SCL_EX_SHELL_CURSOR_MOVE_EN
#define SCL_EX_SHELL_CURSOR_MOVE_EN 1u
#endif

/* 单词级删除（Ctrl-W） */
#ifndef SCL_EX_SHELL_WORD_EN
#define SCL_EX_SHELL_WORD_EN     1u
#endif

/* 更完整的行导航（Ctrl-A/E、Ctrl-K、Delete） */
#ifndef SCL_EX_SHELL_NAV_EN
#define SCL_EX_SHELL_NAV_EN      1u
#endif
